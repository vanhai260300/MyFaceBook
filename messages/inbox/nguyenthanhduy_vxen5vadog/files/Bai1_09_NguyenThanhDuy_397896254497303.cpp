...
void BRW_Node_GTP_09(Node_BnTr_09 *Tr_09)
{
	if(Tr_09!=NULL)
	{
		printf("%s\t",Tr_09->ten_09);
		BRW_Node_GTP_09(Tr_09->Adr_TrL_09);		
		BRW_Node_GTP_09(Tr_09->Adr_TrR_09);
	}
}
void BRW_Node_TPG_09(Node_BnTr_09 *Tr_09)
{
	if(Tr_09!=NULL)
	{		
		BRW_Node_TPG_09(Tr_09->Adr_TrL_09);		
		BRW_Node_TPG_09(Tr_09->Adr_TrR_09);
		printf("%s\t",Tr_09->ten_09);
	}
}
int Count_09(Node_BnTr_09 *Tr_09)
{
	if(Tr_09==NULL)
		return 0;
	else	
		return 1+Count_09(Tr_09->Adr_TrL_09)+Count_09(Tr_09->Adr_TrR_09);
...
main()
{
	...
	BRW_Node_GTP_09(Tree_09);
	printf("\nDanh sach nhap theo Trai Phai Goc: ");
	BRW_Node_TPG_09(Tree_09);
	printf("\nSo sinh vien: %d",Count_09(Tree_09));
