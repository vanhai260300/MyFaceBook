...
void Search(Node_BnTr_09 *Tr, char t[],int &d)
{
	if(Tr!=NULL)
	{
		if(strcmp(Tr->ten_09,t)==0)
			d=d+1;
		Search(Tr->Adr_TrR_09,t,d);
		Search(Tr->Adr_TrL_09,t,d);		
	}
}
main()
{
	...
	fflush(stdin);
	gets(T_09);
	Search(Tree_09,T_09,d_09);
	printf("Co: %d sinh vien can tim",d_09);
