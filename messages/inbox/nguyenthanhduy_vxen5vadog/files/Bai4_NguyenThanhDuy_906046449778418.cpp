...
void BRW_ITPoint(Node_List *H, Node_List **H1, Node_List **H2)
{
	Node_List *tmp, *p;
	*H1=NULL;
	*H2=NULL;
...
main()
{
	...
	Hd=Delete(Hd,l);
	BRW_IT(Hd);
	BRW_ITPoint(Hd, &Ds1, &Ds2);
	printf("Danh sach sv diem duoi 5: \n");
	BRW_IT(Ds1);
	printf("Danh sach sv diem tren 5: \n");
	BRW_IT(Ds2);
}
